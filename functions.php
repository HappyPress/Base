<?php
/**
 * HappyPress Base functions and definitions
 *
 ...
 * @return void
 */
if ( ! function_exists( 'happypressbase_setup' ) ) {
	function happypressbase_setup() {
		...
		add_image_size( 'happypress_base_theme_post_feature_full_width', 806, 300, true );
...
add_action( 'after_setup_theme', 'happypressbase_setup' );
 ...
 */
if ( ! function_exists( 'happypressbase_fonts_url' ) ) {
	function happypressbase_fonts_url() {
		$fonts_url = '';
		$subsets = 'latin';
 ...
 */
function happypressbase_mce_css( $mce_css ) {
	$fonts_url = happypressbase_fonts_url();
...
add_filter( 'mce_css', 'happypressbase_mce_css' );
...
add_action( 'widgets_init', 'happypressbase_widgets_init' );
 ...
 * @return void
 */
if ( ! function_exists( 'happypressbase_scripts_styles' ) ) {
	function happypressbase_scripts_styles() {
...
add_action( 'wp_enqueue_scripts', 'happypressbase_scripts_styles' );
 ...
 * @return void
 */
if ( ! function_exists( 'happypressbase_the_custom_logo' ) ) {
	function happypressbase_the_custom_logo() {
		$siteTitleStr = "";
 ...
 * simply create your own happypressbase_comment(), and that function will be used instead.
 *
 ...
 * @return void
 */
if ( ! function_exists( 'happypressbase_comment' ) ) {
	function happypressbase_comment( $comment, $args, $depth ) {
 ...
 */
if ( ! function_exists( 'happypressbase_comment_form_default_fields' ) ) {
	function happypressbase_comment_form_default_fields( $fields ) {
...
add_action( 'comment_form_default_fields', 'happypressbase_comment_form_default_fields' );
...
add_action( 'comment_form_field_comment', 'happypressbase_comment_form_field_comment' );
 ...
 * @return void
 */
if ( ! function_exists( 'happypressbase_posted_on' ) ) {
	function happypressbase_posted_on() {
		$post_icon = '';
 ...
 * @return void
 */
if ( ! function_exists( 'happypressbase_entry_meta' ) ) {
	function happypressbase_entry_meta() {
 ...
 * @return void
 */
if ( ! function_exists( 'happypressbase_content_width' ) ) {
	function happypressbase_content_width() {
...
add_action( 'template_redirect', 'happypressbase_content_width' );
 ...
 */
function happypressbase_remove_more_jump_link( $link ) {
...
add_filter( 'the_content_more_link', 'happypressbase_remove_more_jump_link' );
...
/**
 * Replaces "[...]" (appended to automatically generated excerpts) with the happypressbase_continue_reading_link().
 *
 * @since HappyPress Base 1.0
 *
 ...
 */
if ( ! function_exists( 'happypressbase_auto_excerpt_more' ) ) {
	function happypressbase_auto_excerpt_more( $more ) {
		return happypressbase_continue_reading_link();
	}
}
add_filter( 'excerpt_more', 'happypressbase_auto_excerpt_more' );
 ...
 */
if ( ! function_exists( 'happypressbase_get_credits' ) ) {
 ...
 * @return void
 */
if ( ! function_exists( 'happypressbase_before_woocommerce_wrapper' ) ) {
	function happypressbase_before_woocommerce_wrapper() {
 ...
 * @return void
 */
if ( ! function_exists( 'happypressbase_after_woocommerce_wrapper' ) ) {
	function happypressbase_after_woocommerce_wrapper() {
 ...
 * @return void
 */
function happypressbase_is_woocommerce_active() {
 ...
 * @return void
 */
if ( ! function_exists( 'happypressbase_setup_woocommerce_wrappers' ) ) {
	function happypressbase_setup_woocommerce_wrappers() {
		if ( happypressbase_is_woocommerce_active() && is_woocommerce() ) {
				add_action( 'happypressbase_before_woocommerce', 'happypressbase_before_woocommerce_wrapper', 10, 0 );
				add_action( 'happypressbase_after_woocommerce', 'happypressbase_after_woocommerce_wrapper', 10, 0 );
		}
	}
}
add_action( 'template_redirect', 'happypressbase_setup_woocommerce_wrappers', 9 );
 ...
 * @return void
 */
if ( ! function_exists( 'happypressbase_woocommerce_before_main_content' ) ) {
	function happypressbase_woocommerce_before_main_content() {
		if ( is_product() ) {
...
add_action( 'woocommerce_before_main_content', 'happypressbase_woocommerce_before_main_content', 10 );
 ...
 * @return void
 */
if ( ! function_exists( 'happypressbase_woocommerce_after_main_content' ) ) {
	function happypressbase_woocommerce_after_main_content() {
		echo '</div>';
	}
}
add_action( 'woocommerce_after_main_content', 'happypressbase_woocommerce_after_main_content', 10 );
 ...
 * @return void
 */
if ( ! function_exists( 'happypressbase_remove_woocommerce_sidebar' ) ) {
	function happypressbase_remove_woocommerce_sidebar() {
		if ( is_product() ) {
			remove_action( 'woocommerce_sidebar', 'woocommerce_get_sidebar', 10 );
		}
	}
}
add_action( 'woocommerce_before_main_content', 'happypressbase_remove_woocommerce_sidebar' );
 ...
 * @return void
 */
if ( ! function_exists( 'happypressbase_shop_product_count' ) ) {
	function happypressbase_shop_product_count( $numprods ) {
		return 12;
	}
}
add_filter( 'loop_shop_per_page', 'happypressbase_shop_product_count', 20 );
...
add_filter( 'woocommerce_pagination_args', 'happypressbase_woocommerce_pagination_args', 10 );
